                ...
                <div class="card-body p-3">
                    ...
                    <div class="row">
                        <div class="col col-md-6">
                            <div class="text-end">
                                <?php if (!empty($variant) && 'S' == $variant['schedule_type']) : ?>
                            ...
                            if (!isset($variant['id'])) {
                                ...
                                echo '<div class="mb-3"><label for="service_duration_minutes" class="form-label ">' . lang('ServiceVariant.field.service_duration_minutes') . '</label><input id="service_duration_minutes" class="form-control" type="text" readonly="readonly" value="' . generate_duration_label($variant['service_duration_minutes']) . '" /></div>';
                            }
