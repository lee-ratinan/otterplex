...
return [
    ...
    'response-msg'       => [
        ...
        'success' => [
            ...
            'data-deleted'          => 'ข้อมูลของคุณได้รับการลบเรียบร้อยแล้ว',
    ...
    'buttons'            => [
        'new'             => '<i class="fa-solid fa-circle-plus"></i> สร้างใหม่',
        'edit'            => '<i class="fa-solid fa-pen-to-square"></i> แก้ไข',
        'save'            => '<i class="fa-solid fa-floppy-disk"></i> บันทึก',
        'upload'          => '<i class="fa-solid fa-cloud-arrow-up"></i> อัปโหลด',
        'remove'          => '<i class="fa-solid fa-trash-can"></i> ลบ',
        'remove-confirm'  => '<i class="fa-solid fa-triangle-exclamation"></i> ยืนยันการลบ',
    ...
    'email'              => [
        ...
        'account-activation' => [
            'subject' => 'การเปิดใช้งานบัญชี OtterNova',
            'message' => 'ยินดีต้อนรับสู่ OtterNova! เรารู้สึกยินดีเป็นอย่างยิ่งที่ได้ให้บริการคุณ<br><br>เพื่อดำเนินการตั้งค่าต่อ กรุณาเปิดใช้งานบัญชี OtterNova ของคุณโดยคลิก <a href="{0}" target="_blank">ที่นี่</a> หรือใช้ลิงก์ด้านล่างนี้:<br><br>{1}',
        ],
        'new-user'           => [
            'subject' => 'ยินดีต้อนรับสู่ OtterNova – บัญชีของคุณถูกสร้างเรียบร้อยแล้ว',
            'message' => 'ยินดีต้อนรับ! บัญชี OtterNova ของคุณถูกสร้างเรียบร้อยแล้ว คุณสามารถเปิดใช้งานบัญชีของคุณได้โดยคลิกลิงก์ด้านล่าง จากนั้นเข้าสู่ระบบด้วยชื่อผู้ใช้และรหัสผ่านดังต่อไปนี้<br><br>ลิงก์สำหรับเปิดใช้งานบัญชี: <a href="{0}" target="_blank">{0}</a><br><br>ชื่อผู้ใช้: <b>{1}</b><br><br>รหัสผ่าน: <b>{2}</b>',
        ]
    ]
];
