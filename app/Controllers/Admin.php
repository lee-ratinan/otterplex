    ...
    public function business_post(): ResponseInterface
    {
        ...
        try {
            ...
            if ('save_business' == $script_action) {
                $fields      = ['business_type_id', 'business_name', 'business_slug', 'allow_advance_booking', 'tax_percentage', 'tax_inclusive', 'mart_primary_color', 'mart_text_color', 'mart_background_color', 'currency_code'];
                $data        = [];
